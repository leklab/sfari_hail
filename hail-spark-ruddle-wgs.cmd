...
do
	d=`date`
	echo "$d Processing: SPARK_WGS_1.chr${c}.JoinCalling.vcf.gz" >> ~/hail_progress.txt

	python submit.py --master ${MASTER_URL} hail_scripts/hail_wgs_annotate_pipeline.py \
				--spark-home $SPARK_HOME --num-executors $((SLURM_NTASKS * SLURM_CPUS_PER_TASK)) \
				--driver-memory 16G --executor-memory 8G \
				-i /home/ml2529/scratch60/SFARI/SPARK_WGS_1.chr${c}.JoinCalling.vcf.gz \
				-m /home/ml2529/project/SFARI/SPARK_wgs_meta.tsv \
				-o /home/ml2529/scratch60/SFARI/hail_tables_wgs3/SPARK_WGS_1.chr${c}.JoinCalling.exome.ht
done
